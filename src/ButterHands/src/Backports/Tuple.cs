...
// and creatively commented with this line and the one above.
...
#endif
		IComparable, IComparable<Tuple>, IValueTupleInternal
	{
		/// <summary>
		/// Returns a value that indicates whether the current <see cref="Tuple"/> instance is equal to a specified object.
		/// </summary>
		/// <param name="obj">The object to compare with this instance.</param>
		/// <returns><see langword="true"/> if <paramref name="obj"/> is a <see cref="Tuple"/>.</returns>
		...
		/// <summary>
		/// Returns a string that represents the value of this <see cref="Tuple"/> instance.
		/// </summary>
		/// <returns>The string representation of this <see cref="Tuple"/> instance.</returns>
		/// <remarks>
